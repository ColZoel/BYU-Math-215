# -*- coding: utf-8 -*-
"""Lab 3Plotting_iteration_roundoff.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1J02g3RJRT8XnYxEbcvM9lNLgoL6_48_-
...
def g(x):
  y= x**4 -2*x**3 - 17*x**2 + 4*x +30
  return y # Put your return value, i.e. the value of g(x), here.

def g_prime(x):
  y_p= 4*x**3 -6*x**2 - 34*x +4
  return y_p # Put your return value, i.e. the value of the derivative g'(x), here.
