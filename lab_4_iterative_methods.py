# -*- coding: utf-8 -*-
"""Lab 4 - Iterative_methods.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1_o_JxyK8ezz5WZzWTcncW9cyivhFQgal
...
def gs1_iteration(x,y):
  ...
  y_n = new_y
  return [x_n, y_n]
    # Put your code here. # Your return statement should return a list of the form [new_x,new_y]
...
def gs1_method(n): 
  ...
  for i in range(n):
    ...
    y_n = new_y
  return [x_n, y_n]
    # Put your code here. # Your return statement should return a list of the form [x_n,y_n]
...
def gs1_error(n):
  return np.linalg.norm(np.array(gs1_method(n)) - np.array([1,1]))
...
def gs2_iteration(x,y): 
  ...
  y_n = new_y
  return [x_n, y_n]
   # Your return statement should return a list of the form [new_x,new_y]
...
def gs2_error(n): 
  return np.linalg.norm(np.array(gs2_method(n)) - np.array([2,1]))
    # Put your code here.
...
def gs3_iteration(x,y,z): 
  new_x = -8/5 + (2/5)*y - (3/5)*z
  new_y = 51/2 - (1/4)*new_x + z
  new_z = -45/2 + (1/2)*new_x + (1/2)*new_y
...
def gs3_method(n): 
    ...
    z_n=0
    for i in range(n):
      new_x = -8/5 + (2/5)*y_n - (3/5)*z_n
      new_y = 51/2 - (1/4)*new_x + z_n
      new_z = -45/2 + (1/2)*new_x + (1/2)*new_y
      x_n=new_x
      y_n=new_y
      z_n=new_z
    return [x_n,y_n,z_n]
    # Put your code here.
     # Your return statement should return a list of the form [x_n,y_n,z_n]
